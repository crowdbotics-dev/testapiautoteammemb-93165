...
## Project Structure
    ...
    ├── testapiautoteammemb_93165  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_93165`
...
2. Clone this repo and `cd testapiautoteammemb_93165`
